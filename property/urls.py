...
urlpatterns = [
    ...
    path('hotel/detail/<slug>/', HotelDetail, name='hotel-detail'),
    path('hotel-rooms/', HotelRoomListView.as_view(), name='hotel-rooms'),
    path('hotel-room/detail/<slug>/', HotelRoomDetail, name='hotel-room-detail'),
]